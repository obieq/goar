...
func TestMin(t *testing.T) {
	...
	for _, min := range []Min{Min{"key1", 10}, ValidMin(10)} {
...
func TestMax(t *testing.T) {
	...
	for _, max := range []Max{Max{"key1", 10}, ValidMax(10)} {
...
func TestRange(t *testing.T) {
	...
	goodValidators := []Range{
		Range{Key: "key1", Min: Min{"key1", 10}, Max: Max{"key1", 100}},
		ValidRange(10, 100),
	}
	...
	goodValidators = []Range{
		Range{Key: "key1", Min: Min{"key1", 10}, Max: Max{"key1", 10}},
		ValidRange(10, 10),
	}
	for _, rangeValidator := range goodValidators {
		performTests(rangeValidator, tests, t)
	...
	badValidators := []Range{
		Range{Key: "key1", Min: Min{"key1", 100}, Max: Max{"key1", 10}},
		ValidRange(100, 10),
	}
...
func TestMinSize(t *testing.T) {
	...
	for _, minSize := range []MinSize{MinSize{"key1", 1}, ValidMinSize(1)} {
...
func TestMaxSize(t *testing.T) {
	...
	for _, maxSize := range []MaxSize{MaxSize{"key1", 2}, ValidMaxSize(2)} {
...
func TestLength(t *testing.T) {
	...
	for _, length := range []Length{Length{"key1", 2}, ValidLength(2)} {
...
func TestMatch(t *testing.T) {
	...
	for _, match := range []Match{Match{"key1", regex}, ValidMatch(regex)} {
...
func TestEmail(t *testing.T) {
	...
	for _, email := range []Email{Email{"key1", Match{"key1", emailPattern}}, ValidEmail()} {
